...
public class TripDAO {
    ...
    public long deleteTrip(long id) {
        String selection = TripEntry.COL_ID + " = ?";
        String selectionitem = TripItemEntry.COL_Trip_ID + " = ?";
        String[] selectionArgs = {String.valueOf(id)};
        dbWrite.delete(TripItemEntry.TABLE_NAME,selectionitem,selectionArgs);
    ...
    protected ContentValues getTripValues(Trip trip) {
        ...
        values.put(TripEntry.COL_MAX_BUDGET,trip.getmaxbudget());
    ...
    protected ArrayList<Trip> getTripFromDB(String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy) {
        ...
        while (cursor.moveToNext()) {
            ...
            tripItem.setmaxbudget(cursor.getLong(cursor.getColumnIndexOrThrow(TripEntry.COL_MAX_BUDGET)));
