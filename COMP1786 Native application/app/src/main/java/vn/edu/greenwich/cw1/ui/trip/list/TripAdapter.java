...
public class TripAdapter extends RecyclerView.Adapter<TripAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String owner = holder.itemView.getResources().getString(R.string.label_Risk);
        String risk = holder.itemView.getResources().getString(R.string.label_tenant);
        holder.listItemTripName.setText(trip.getName());
        holder.listItemTripStartDate.setText(trip.getStartDate());
        holder.listItemTripOwner.setText(trip.getRisk() == 1 ? owner : risk);
